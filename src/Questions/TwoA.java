...
class TwoA {
    //    finding the nearest ancestors in a tree where two values are "relatively prime
    ...
    //raverse the tree and find the nearest ancestor that has a relatively prime
...
//    returns a list of nearest ancestors for each node in the tree.

    public static void main(String[] args) {
        int[][] edges =  {{0,1}, {0,2}, {1,3}, {1,4}, {2,5}, {2,6}};
        int [] values = {3,2,6,6,4,7,12};
        TwoA twoA = new TwoA();
        int[] ans = twoA.getCoprimes(values,edges);
